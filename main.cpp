...
int main(int argc, char* argv[]) {
    ...
    if (commandLineArgs.HasKey("h") || commandLineArgs.HasKey("help"))
    {
        ...
        for (const auto& options : std::vector<std::array<string, 4>>{
                ...
                {"string",          "color_prefit_plus", "kBlue",       "x Colour for + variation. Formats: kBlue | RGB(x, y, z) | RGBA(x, y, z, a) || x in [0..255]"},
                {"string",          "color_prefit_minus", "kGreen",     "x Colour for + variation. Formats: kBlue | RGB(x, y, z) | RGBA(x, y, z, a) || x in [0..255]"},
                {"string",          "color_postfit_plus", "kBlue",      "x Colour for - variation. Formats: kBlue | RGB(x, y, z) | RGBA(x, y, z, a) || x in [0..255]"},
                {"string",          "color_postfit_minus","kGreen",     "x Colour for - variation. Formats: kBlue | RGB(x, y, z) | RGBA(x, y, z, a) || x in [0..255]"},
